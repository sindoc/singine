%% silkpage_coat_of_arms_05.tex — Lotus and Eastern Recursion
%%
%% Uses:
...
%%
%% compile: xelatex silkpage_coat_of_arms_05.tex
...
\begin{tikzpicture}[x=1cm,y=1cm,line cap=round,line join=round]
  ...
  \node[opacity=0.07, rotate=6] at (-4.7,4.9) {\includegraphics[width=6.8cm]{Eastern_Pattern.svg.png}};
  \node[opacity=0.07, rotate=-6, xscale=-1] at (4.7,4.9) {\includegraphics[width=6.8cm]{Eastern_Pattern.svg.png}};
  ...
  \foreach \a in {90,126,162,198,234,270,306,342,18,54} {
    \begin{scope}[shift={(\a:3.5)}]
      \node[inner sep=0pt, opacity=0.95] {\includegraphics[width=0.26cm]{Lotus_10.svg.png}};
    \end{scope}
  }
